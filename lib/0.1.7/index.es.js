...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$5, [
    _ctx.actionable ? renderSlot(_ctx.$slots, "action", { key: 0 }, () => [
      ...
      createVNode(_component_a_checkbox_group, {
        ...
        default: withCtx(() => [
          createElementVNode("div", {
            ...
            _ctx.checkList.matchList.length && _ctx.checkList.notMatchList.length ? (openBlock(), createElementBlock("div", _hoisted_5$2, _hoisted_7$2)) : createCommentVNode("", true),
        ...
        _ctx.tagList.more.length ? (openBlock(), createBlock(_component_a_tag, { key: 0 }, {
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "more", {}, () => [
              _ctx.maxMode === "left" ? (openBlock(), createElementBlock("span", _hoisted_6$1, toDisplayString(_ctx.tagList.more.length) + toDisplayString(_ctx.maxTagText), 1)) : createCommentVNode("", true),
              _ctx.maxMode === "all" ? (openBlock(), createElementBlock("span", _hoisted_7$1, toDisplayString(_ctx.tags.length) + toDisplayString(_ctx.maxTagText), 1)) : createCommentVNode("", true)
            ])
          ]),
          _: 3
        })) : createCommentVNode("", true)
            ...
            createElementVNode("div", _hoisted_6, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.tagsValue, (item, index2) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createVNode(_component_condition_tag, mergeProps({
                    onClose: (e2) => _ctx.handleCloseTag(index2, item),
                    maxTagCount: 2
                  }, _ctx.tagParams, {
                    tags: item.tags,
                    label: item.label
                  }), null, 16, ["onClose", "tags", "label"])
                ], 8, _hoisted_7);
              }), 128))
            ])
          ])
